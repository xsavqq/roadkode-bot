...
# OpenAI для анализа фото и оценки примерного веса
...
# Юзернейм менеджера для связи из бота
MANAGER_USERNAME = os.getenv("MANAGER_USERNAME", "@roadkode_mgr")
...
# Бонус пригласившему = вес_кг заказа реферала * REFERRAL_BONUS_PER_KG
REFERRAL_BONUS_PER_KG = float(os.getenv("REFERRAL_BONUS_PER_KG", "100"))

# Ссылки на канал и чат — используются в тексте "О боте"
CLOSED_CHAT_URL = os.getenv("CLOSED_CHAT_URL", "https://t.me/+PNTIUGCHSow0ODRi")
CLOSED_CHANNEL_URL = os.getenv("CLOSED_CHANNEL_URL", "https://t.me/ROADKODE")
...
def yuan_rate_text() -> str:
    ...
    return (
        ...
        "Бот рассчитывает стоимость товара по этому курсу и добавляет комиссию сервиса."
    )
